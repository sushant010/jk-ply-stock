...
import NewMainStocks from './NewMainStocks';

function DashboardMultiple({ handleSignOut }) {
    const [selectedMenuItem, setSelectedMenuItem] = useState('NewMainStocks');
    ...
    return (
        <div>
            <div className="min-h-screen bg-[#1e1e1e]">
                <aside className={`bg-gradient-to-br from-gray-800 to-gray-900 fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0 ${isMenuOpen ? 'translate-x-0' : '-translate-x-80'}`} style={{ zIndex: 999 }}>
                    <div className="relative border-b border-white/20">
                        <div className="flex items-center bg-[#0098ff] rounded-t-lg gap-4 py-6 px-8" >
                            <h6 className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-white">Dashboard - Handling</h6>
                        </div>
                        ...
                        <ul className="mb-4 flex flex-col gap-1">
                            ...
                            <li>
                                ...
                                <button onClick={handleSignOut} className="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                                    ...
                                    <p className="block antialiased font-sans text-sm leading-normal text-white font-black uppercase opacity-75">Sign-Out</p>
                                </button>
                ...
                <div className="p-4 xl:ml-80">
                    <nav className="block w-full max-w-full text-white shadow-none rounded-xl transition-all py-2 bg-[#2d2d30]  md:px-4 lg:px-4 xl:px-4 px-2">
                                ...
                                <nav aria-label="breadcrumb" className="w-max">
                                    <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
                                        <li className="flex items-center text-blue-gray-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-light-blue-500">
                                            ...
                                            <p className="block antialiased font-sans text-sm leading-normal text-[#0098ff] font-normal opacity-80 transition-all hover:text-blue-500 hover:opacity-100">dashboard</p>
                                        ...
                                        <li className="flex items-center text-[#0098ff] opacity-80 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-blue-500">
                                            <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">home</p>
                                        </li>
                                    </ol>
                                </nav>
                                <h6 className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-gray-200">home</h6>
                            </div>
                    ...
                    <div className="text-blue-gray-600">
                        {selectedMenuItem === 'NewMainStocks' && <NewMainStocks />}
                    </div>
